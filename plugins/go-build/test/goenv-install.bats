...
Downloading ${LATEST_VERSION}.tar.gz...
-> http://localhost:8090/${LATEST_VERSION}/${LATEST_VERSION}.tar.gz
Installing Go Darwin 10.8${arch}64bit ${LATEST_VERSION}...
Installed Go Darwin 10.8${arch}64bit ${LATEST_VERSION} to ${GOENV_ROOT}/versions/${LATEST_VERSION}
...
Downloading 1.2.2.tar.gz...
-> http://localhost:8090/1.2.2/1.2.2.tar.gz
Installing Go Darwin 10.8${arch}64bit 1.2.2...
Installed Go Darwin 10.8${arch}64bit 1.2.2 to ${GOENV_ROOT}/versions/1.2.2
